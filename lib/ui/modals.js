...
module.exports.lookupHelp = function (e) {
  e.preventDefault()

  // render

  var m = modal(h('.lookup-code-form',
    h('.help',
      h('h3', 'Can\'t find your friend?'),
      h('p', 'Have them send you a lookup code!'),
      h('hr'),
      h('p', ' If they need help, send these instructions:'),
      h('.help-section',
...
module.exports.useLookup = function (code) {

  // render

  var status = h('div', 'Initializing...')
  var m = modal(h('.modal-form', h('h3', 'User Lookup'), status))
