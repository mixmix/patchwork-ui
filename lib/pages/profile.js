...
module.exports = function () {
  ...
  // render page
  require('./webview')({
    param: '&BT4kj89QW+yUIa+DpU1wes50SfqRm2DZIN54RQAyPbc=.sha256',
    sideview: h('.profile-controls',
      ...
      (followers.length) ? h('.relations', h('h4', 'followers'), com.userHexagrid(followers, { nrow: 4 })) : '',
      (followeds.length) ? h('.relations', h('h4', 'follows'), com.userHexagrid(followeds, { nrow: 4 })) : ''
    )
  })
