...
module.exports = function (app) {
  ...
  var followers1  = social.followedFollowers(app, app.user.id, pid, true)
  var followers2  = social.unfollowedFollowers(app, app.user.id, pid)
  ...
  app.setPage('profile', h('.layout-twocol',
    ...
    h('.layout-rightnav',
      h('.profile-controls',
        com.contactPlaque(app, profile, followers1.length + followers2.length, flaggers.length),
        (!isSelf) ?
        [
        ...
        (followers1.length) ? h('.relations', h('h4', 'followers you follow'), com.userHexagrid(app, followers1, { nrow: 4 })) : '',
        (followers2.length) ? h('.relations', h('h4', 'followers you don\'t follow'), com.userHexagrid(app, followers2, { nrow: 4 })) : ''
      )
    )
  ))
