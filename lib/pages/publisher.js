...
module.exports = function () {
  ...
  app.ssb.patchwork.getSite(app.user.id, function (err, published) {

    // markup

    var publishedTree = published ? toTree(published) : null
    var folderPath = o('/Users/paulfrazee/homesite')
    var folderData = o()
