...
module.exports = function () {
  ...
  ui.setPage('home', h('.layout-twocol',
    h('.layout-main', 
      com.notifications(),
      com.composer.header({ placeholder: 'Share a message with the world...', onpost: onpost }),
      livemodeProgressBars,
      com.messageFeed({ feed: app.ssb.patchwork.createHomeStream, onempty: onempty, filter: homeFilter, infinite: true, live: hlf })
    ),
    h('.layout-rightnav',
      com.sidenav(),
  ...
  function onempty (el) {
    if (app.homeMode.view == 'all')
      el.appendChild(com.welcomehelp())
  }
