...
module.exports = function (opts) {
  ...
  ui.setPage('webview', h('.layout-grid',
    ...
    (opts && opts.sideview) ? h('.layout-grid-col.webview-right', opts.sideview) : ''
  ...
  function resize () {
    [
      ...
      [document.querySelector('.webview-page .layout-grid'), 2],
      [document.querySelector('.webview-page .webview-left'), 2],
      [document.querySelector('.webview-page .webview-right'), 2]
