...
module.exports = function (app) {
  ...
  app.setPage('inbox', [
      ...
      com.messageFeed(app, { render: com.messageOneline, feed: app.ssb.phoenix.createInboxStream, filter: filter, onempty: onempty, infinite: true })
  ])
  ...
  function filter (msg) {
    ...
    return a == app.user.id || social.follows(app, app.user.id, a)
  }
}
