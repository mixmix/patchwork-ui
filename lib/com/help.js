...
exports.side = function () {
  ...
  function link (url, text) {
    return [
      h('a', { style: 'color: #555', href: url, title: text }, com.icon('arrow-right'), ' ', text),
      h('br')
    ]
  }
  ...
  return h('div', { style: 'display: flex; margin-bottom: 100px' },
    ...
    h('div',
      ...
      h('a.text-muted.noicon', { style: 'color: #555', href: 'https://github.com/ssbc/patchwork/issues/new', target: '_blank', title: 'File a suggestion or issue' }, com.icon('bullhorn'), ' File an Issue')
    )
  )
}