  ...
  return h('.message',
    ...
    h('.message-comments',
      ...
      h('.comment',
        ...
        h('.comment-inner',
          h('.markdown',
            h('h4', 'Step 3: Have fun!'),
            h('p', 'You can publish ', h('strong', 'status updates, photos, and files'), ' using the box at the top of your feed. You can also send ', h('strong', 'Secret Messages'), ' to the people you follow (and that follow you) by pressing Compose, top right.'),
            h('p', 'If you have a question, ', a('#/help', 'check out the Help section'), ' and feel free to ', a('#', 'send us your feedback'), '!')
          )
        )
      )
    )
