...
exports.sidehelp = function (app, opts) {
  return h('ul.list-unstyled.sidehelp',
    ...
    h('li', h('a.btn.btn-3d', { onclick: app.ui.inviteModal }, com.icon('ok'), ' Accept Invitation')),
    (!opts || !opts.noMore) ? h('li', h('span', {style:'display: inline-block; padding: 6px 14px'}, a('#/help', [com.icon('question-sign'), 'Help']))) : ''
  )
}
