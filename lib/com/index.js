...
exports.pagenav = function () {
  ...
  var upvotesUnread = (app.indexCounts.upvotesUnread) ? h('span.unread.monospace', app.indexCounts.upvotesUnread) : ''
  var followsUnread = (app.indexCounts.followsUnread) ? h('span.unread.monospace', app.indexCounts.followsUnread) : ''
  var inboxUnread   = (app.indexCounts.inboxUnread)   ? h('span.unread.monospace', app.indexCounts.inboxUnread) : ''
  ...
  return h('.page-nav-inner',
    ...
    h('a.stat', { href: '#/inbox' }, icon('envelope'), ' ', app.indexCounts.inbox, inboxUnread),
    h('a.stat', { href: '#/stars' }, icon('star'), ' ', app.indexCounts.upvotes, upvotesUnread),
    h('a.stat', { href: '#/friends' }, icon('user'), ' ', app.indexCounts.follows, followsUnread),
...
exports.welcomehelp = function () {
  ...
  if (Object.keys(app.user.profile.assignedTo).length == 0) {
    return h('.welcome-help',
      ...
      h('.big-btn', { onclick: modals.invite },
...
exports.sidenav = function (opts) {
  ...
  return h('ul.list-unstyled.sidenav',
    h('li', h('a.btn.btn-3d', { href: '#/address-book' }, icon('search'), ' Find a Friend')),
