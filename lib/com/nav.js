...
exports.pagenav = function () {
  ...
  return h('.page-nav-inner',
    ...
    addressbar(),
    (app.page.id == 'webview') ? [
      (ssbref.isBlobId(app.page.param)) ? h('a', { onclick: oncomments, className: togglecls('comments'), title: 'Toggle the comments panel' }, com.icon('comment')) : '',
...
exports.sidenav = function (opts) {
  ...
  return h('ul.list-unstyled.sidenav',
    ...
    h('li', h('span', {style:'display: inline-block; padding: 4px 12px 2px'}, h('a.noicon', { href: 'https://github.com/ssbc', target: '_blank', title: 'File a suggestion or issue' }, com.icon('bullhorn'), 'Send Feedback'))),
