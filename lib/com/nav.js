...
exports.pagenav = function () {
  ...
  function onmenuclick (e) {
    ...
    ui.dropdown(this, [
      ...
      // h('a.item', { href: '#/stars', title: 'Stars on your posts, and stars by you' }, com.icon('star'), ' Stars (', app.observ.indexCounts.votesUnread, ')'),
      // h('a.item', { href: '#/friends', title: 'Friends, followers, and other users' }, com.icon('user'), ' Friends (', app.observ.indexCounts.followsUnread, ')'),
      h('hr'),
      h('a.item', { href: '#/profile/'+app.user.id, title: 'View your site' }, com.icon('globe'), ' Your Site'),
      h('a.item', { href: '#/setup', title: 'Edit your profile' }, com.icon('user'), ' Your Profile'),
      h('hr'),
