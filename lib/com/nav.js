...
exports.pagenav = function () {
  ...
  function onmenuclick (e) {
    ...
    ui.dropdown(this, [
      ...
      h('a.item.noicon', { href: 'https://github.com/ssbc', target: '_blank', title: 'File a suggestion or issue' }, com.icon('bullhorn'), ' Send Feedback'),
  ...
  var stats = u.getPubStats()
  if (!stats.membersof || !stats.active)
    syncWarning = h('a', { href: '#/sync', title: 'Warning! You are not online' }, com.icon('warning-sign.text-danger'))
