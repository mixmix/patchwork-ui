...
function addressbar () {
  ...
  if (options && !options[app.page.view])
    app.page.view = Object.keys(options)[0]

  var addressInput = h('input', { value: '', onfocus: onfocus, onkeyup: onkeyup })
  var viewSelect = h('select', { onchange: onviewchange }, opts(options))
  viewSelect.value = app.page.view
  ...
  function onviewchange (e) {
    window.location.hash = '#/'+app.page.id+((app.page.param)?('/'+app.page.param):'')+'?view='+e.target.value
  }
...
exports.pagenav = function () {
  ...
  function onmenuclick (e) {
    ...
    ui.dropdown(this, [
      ...
      h('hr'),
      h('a.item', { href: '#/', title: 'Home launcher' }, com.icon('home'), ' Home'),
      h('a.item', { href: '#/profile/'+app.user.id+'?view=site', title: 'View your site' }, com.icon('globe'), ' Your Site'),
      h('a.item', { href: '#/profile/'+app.user.id+'?view=profile', title: 'View your profile page' }, com.icon('user'), ' Your Profile'),
      h('a.item', { href: '#/profile/'+app.user.id+'?view=files', title: 'View your files' }, com.icon('file'), ' Your Files'),
      h('hr'),
      h('a.item', { href: '#/sync', title: 'Review the status of your mesh network connections' }, com.icon('circle-arrow-down'), ' Network Sync ', syncWarningIcon),
