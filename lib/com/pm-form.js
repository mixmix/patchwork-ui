...
module.exports = function (opts) {
  ...
  function post (e) {
    ...
    uploadFiles(function (err, extLinks) {
      if (err)
        return ui.pleaseWait(false), enable(), modals.error('Error Uploading Attachments', err, 'This error occurred while trying to upload the attachments to a new secret message.')
  ...
  function filesAdded (e) {
    ...
    if (rejections.length)
      modals.error('Error Attaching File', rejections.join(', '))
    renderAttachments()
  }
  ...
  function uploadFiles (cb) {
    ...
    ui.setStatus('Uploading ('+attachments.length+' files left)...')
    ...
    function next (err) {
      ...
      if (n === attachments.length) {
        ...
        ui.setStatus('Uploading ('+(attachments.length-n)+' files left)...')
    }
  }
