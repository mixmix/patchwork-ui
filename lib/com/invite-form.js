...
module.exports = function (app, opts) {
  ...
  var form = h('.invite-form',
    ...
    error,
    h('hr'),
    h('p.text-muted', h('strong', 'Pub servers help you communicate across the Internet.')),
    h('p.text-muted',
      'Don\'t have an invite to a pub? ',
      h('a', { href: 'https://github.com/ssbc/scuttlebot/wiki/Pub-Servers', target: '_blank' }, 'Register for one here.'),
      h('br'),
      'Neckbeards can setup their own pubs. ',
